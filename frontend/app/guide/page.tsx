...
const USER_GUIDE: Section[] = [
  {
    ...
    blocks: [
      {
        items: [
          "YOPEY Befriender is here to help you become a volunteer dementia befriender, every step of the way. It finds care homes near you and helps you write a first message to them, then reminds you to follow up if you have not heard back. It can share free dementia training so you feel confident before you visit, and afterwards it helps you polish your visit reports. The goal is simple: to help you start spending time with elderly residents and make a real difference.",
        ],
      },
      {
